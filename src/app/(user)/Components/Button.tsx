  ...
  if (baseButton) {
    return (
      <Link
        href={href}
        target={target}
        className={`focus:outline-none text-black border-2 border-highlight bg-base hover:bg-highlight-2 focus:ring-4 focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ${className} flex w-fit items-center duration-300`}
      >
        {withArrow && (
  ...
  if (baseButton) {
    return (
      <button
        type={type}
        onClick={onClick}
        className={`focus:outline-none text-white bg-base hover:bg-white hover:text-black focus:ring-4 border-2 border-white focus:ring-slate-400 font-medium  text-sm px-5 py-2.5 me-2 mb-2 ${className} flex w-fit items-center rounded-lg duration-300`}
      >
        {withArrow ? (
